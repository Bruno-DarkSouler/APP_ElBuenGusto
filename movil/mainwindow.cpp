    ...
    , ui(new Ui::MainWindow)
{
    ...
    menu_lateral->setGeometry(-this->width(), 0, this->width(), this->height());
    ...
    menu_carrito->setGeometry(-this->width(), 0, this->width(), this->height());
    ...
    connect(menu_lateral->devolver_boton_cerrar(), &QPushButton::clicked, this, &MainWindow::abrir_menu_lateral);
    connect(ui->abrir_carrito, &QPushButton::clicked, this, &MainWindow::abrir_menu_carrito);
    connect(menu_carrito->devolver_boton_cerrar(), &QPushButton::clicked, this, &MainWindow::abrir_menu_carrito);
...
void MainWindow::abrir_menu_lateral(){
    ...
    int ancho_menu = menu_lateral->width();
    ...
    animacion->setStartValue(QRect(comienzoX, 0, menu_lateral->width(), menu_lateral->height()));
    animacion->setEndValue(QRect(finalX, 0, menu_lateral->width(), menu_lateral->height()));
    animacion->start();
...
void MainWindow::abrir_menu_carrito(){
    ...
    int ancho_menu = menu_carrito->width();
    int comienzoX, finalX;
    ...
    animacion_menu_carrito->setStartValue(QRect(comienzoX, 0, menu_carrito->width(), menu_carrito->height()));
    animacion_menu_carrito->setEndValue(QRect(finalX, 0, menu_carrito->width(), menu_carrito->height()));
