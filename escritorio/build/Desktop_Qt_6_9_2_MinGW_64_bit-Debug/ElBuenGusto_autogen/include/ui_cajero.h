...
"         "));
        ...
        groupBox_tipoPedido->setMaximumSize(QSize(16777215, 120));
...
"         "));
        ...
        horizontalLayout_programacion->setSpacing(8);
        ...
        dateEdit_fecha->setStyleSheet(QString::fromUtf8("QDateEdit { padding: 4px; border: 2px solid #ddd; border-radius: 4px; font-size: 10px; }"));
        ...
        timeEdit_hora->setStyleSheet(QString::fromUtf8("QTimeEdit { padding: 4px; border: 2px solid #ddd; border-radius: 4px; font-size: 10px; }"));
...
"QPushButton:disabled { background-color: #ccc; color: #999; }"));
    ...
    void retranslateUi(QWidget *PanelCajero)
    {
        ...
        radioButton_inmediato->setText(QCoreApplication::translate("PanelCajero", "Pedido Inmediato", nullptr));
